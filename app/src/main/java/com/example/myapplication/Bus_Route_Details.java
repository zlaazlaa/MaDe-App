...
// Adjust the size of the components
        ...
        if(json.equals("")){
            ...
            json = gson.toJson(busRoute);
            mEditor.putString("BusRouteData", json);
            mEditor.apply();
        }
        busRoute = gson.fromJson(json,BusRoute.class);
